...
// Image Imports are correct and robust for bundlers like Vite
...
export default function BlogSection() {
  return (
    <section className="container py-5 text-center">
      {/* Title: Bold and dark text */}
      <h2 className="fw-bolder" style={{ color: "#2c2c2c", fontSize: "2.5rem" }}>
        Blog Section
      </h2>
      {/* Subtitle: Updated text style matching the image */}
      ...
      <div className="row gy-4 mt-4">
        {blogs.map((blog, index) => (
          <div key={index} className="col-md-3">
            {/* Card structure using the custom blog-card class defined in App.css */}
